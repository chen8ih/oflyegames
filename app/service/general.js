...
exports._list = async (Model, payload, {
  ...
  count = await Model.count(query).exec();
 ...
 */
exports._removes = async (res, Model, ids, key) => {
 ...
 * @param  {[type]}   ids [description]
 */
exports._safeDelete = async (res, Model, ids) => {
 ...
 * @param  {[type]} data    [description]
 */
exports._updateMany = async (res, Model, ids = [], data, {
  query = {}
} = {}) => {
 ...
 * @param  {[type]} data    [description]
 */
exports._addToSet = async (res, Model, id, data, {
  query = {}
} = {}) => {
 ...
 * @param  {[type]} data    [description]
 */
exports._pull = async (res, Model, id, data, {
  query = {}
} = {}) => {
 ...
 * @param  {[type]} data    [description]
 */
exports._inc = async (res, Model, id, data, {
  query = {}
} = {}) => {
